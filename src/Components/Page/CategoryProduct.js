...
class CategoryProduct extends Component{
  ...
  constructor(props){
    ...
    this.onSubmitSearchCategory = this.onSubmitSearchCategory.bind(this)
  }
      ...
      .then(res => {
        ...
        if (this.state.token === null){
          console.log("Dont Have Access Login");
            ...
            this.setState({
            dataApiCategory:res.data.data.data
          })
        }
    });
  }
    ...
    return(
      <div>
        <Grid container justify="center">
          <IconButton onClick={this.onSubmitSearchCategory} fontSize="large">
            <SearchIcon />
          </IconButton> &nbsp;
      ...
      <Grid container style={{justifyContent: 'center'}} className={classes.root} spacing={0}>
        <Grid item xs={11}>
          ...
          {this.state.dataApiCategory.map((data, index) => {
            return(
