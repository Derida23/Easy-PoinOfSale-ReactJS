...
class NewProduct extends Component{
  ...
  constructor(props){
    ...
    this.onSubmitSearchNew = this.onSubmitSearchNew.bind(this)
  }
      ...
      .then(res => {
        if (this.state.token === null){
          console.log("Dont Have Access Login");
            ...
            this.setState({
            dataApiNewProduct:res.data.data.data
          })
        }
    });
  }
  ...
  render(){
    ...
    return(
      ...
      <Grid container justify="center">
        <IconButton  onClick={this.onSubmitSearchNew} fontSize="large">
          <SearchIcon />
        </IconButton> &nbsp;
      ...
      <Grid container style={{justifyContent: 'center'}} className={classes.root} spacing={0}>
        <Grid item xs={11}>
          ...
          {this.state.dataApiNewProduct.map((data, index) => {
            return(
